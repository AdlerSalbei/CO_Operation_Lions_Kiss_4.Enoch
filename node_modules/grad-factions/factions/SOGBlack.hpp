class SOGBLACK {
    ...
    class Type {
        ...
        class Soldier_F {
            ...
            addItemsToBackpack[] = {
                LIST_12("rhs_mag_20Rnd_SCAR_762x51_m61_ap_bk"),
                LIST_4("ACE_bodyBag")
            };
        };
        ...
        class soldier_AAR_F: Soldier_F {
            ...
            backpack = "ga_kitbag_black";
            addItemsToBackpack[] = {
                LIST_2("ACE_200Rnd_65x39_cased_Box_Tracer_Dim")
            };
        };
        ...
        class soldier_AR_F: Soldier_F {
            ...
            primaryWeaponMagazine = "ACE_200Rnd_65x39_cased_Box_Tracer_Dim";
            primaryWeaponMuzzle = "muzzle_snds_H_MG_blk_F";
            primaryWeaponPointer = "";
            primaryWeaponOptics = "FHQ_optic_AC12136";
        ...
        class Soldier_GL_F: Soldier_F {
            backpack = "SMA_BackPack_Black";
            addItemsToBackpack[] = {
                "FancySchmazyWeapon",
                LIST_4("rhsusf_mag_6Rnd_M433_HEDP"),
                LIST_1("rhs_mag_20Rnd_SCAR_762x51_m61_ap_bk")
            };
